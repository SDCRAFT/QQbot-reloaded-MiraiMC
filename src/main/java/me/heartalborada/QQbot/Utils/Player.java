...
public class Player {
    public static String GetPlayerUUID(String name) {
        String data = new Internet().doGet("https://api.mojang.com/users/profiles/minecraft/" + name);
    ...
    public static String GetPlayerUsedName(String Player_UUID) {
        String data = "{\"names\":" + new Internet().doGet("https://api.mojang.com/user/profiles/" + Player_UUID + "/names") + "}";
    ...
    private static String GetPlayerTexturesJson(String Player_UUID) {
        String json = "Error";
        try {
            json = new Internet().Eget("https://sessionserver.mojang.com/session/minecraft/profile/" + Player_UUID);
        } catch (Exception e) {
            e.printStackTrace();
        }
